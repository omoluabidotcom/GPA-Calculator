 ...
 <div class="main_container" id="main_container" >
  ...
  <form action="" method="POST" class="course_form form" id="course_form form" >
    ...
    <div class="course_div div" id="course_div div" >
        ...
        <div class="inline" id="inline" >
        Course Name <br />
        <input type="text" class="course_name second" id="course_name" name="coursename_eleven" /> 
        </div>
  
        <div class="inline" id="inline" >
        Course Unit <br />
        <input type="number" class="course_unit third" id="course_unit" name="courseunit_eleven" />
        </div>
  
        <div class="inline" id="inline" >
        Score <br />
        <input type="number" class="course_score fourth" id="course_score" name="coursescore_eleven" />
        </div>
  
        <div class="inline" id="inline" >
        Grade <br />
        <input type="text" class="course_grade fifth" id="course_grade" name="coursegrade_eleven" />
        </div>
