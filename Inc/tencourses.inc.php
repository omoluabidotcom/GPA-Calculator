...
if (isset($_POST['gpcalc'])) {
    ...
    && !empty($_POST['courseunit_ten']) && !empty($_POST['coursescore_one']) && !empty($_POST['coursescore_two']) 
    && !empty($_POST['coursescore_three']) && !empty($_POST['coursescore_four']) && !empty($_POST['coursescore_five']) 
    && !empty($_POST['coursescore_six']) && !empty($_POST['coursescore_seven']) && !empty($_POST['coursescore_eight']) 
    && !empty($_POST['coursescore_nine']) && !empty($_POST['coursescore_ten']) ) 
    {
        ...
        $coureunitTotal = $courseunit_one + $courseunit_two + $courseunit_three + $courseunit_four + $courseunit_five + $courseunit_six + $courseunit_seven + $courseunit_eight + $courseunit_nine + $courseunit_ten;
        ...
        $gpTotal = $gp_one + $gp_two + $gp_three + $gp_four + $gp_five + $gp_six + $gp_seven + $gp_eight + $gp_nine + $gp_ten;
