...
if (isset($_POST['gpcalc'])) {
    ...
    && !empty($_POST['courseunit_ten']) && !empty($_POST['courseunit_eleven']) && !empty($_POST['coursescore_one']) 
    ...
    && !empty($_POST['coursescore_eleven']) ) 
    {
        ...
        $gpTotal = $gp_one + $gp_two + $gp_three + $gp_four + $gp_five + $gp_six + $gp_seven + $gp_eight + $gp_nine + $gp_ten + $gp_eleven;
