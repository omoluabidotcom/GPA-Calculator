...
if (isset($_POST['gpcalc'])) {
    ...
    && !empty($_POST['coursescore_seven']) && !empty($_POST['coursescore_eight']) && !empty($_POST['coursescore_nine']) 
    && !empty($_POST['coursescore_ten']) && !empty($_POST['coursescore_eleven']) && !empty($_POST['coursescore_twelve']) ) 
    {
        ...
        $gp_twelve = $mainObj->GP($courseunit_twelve, $courseweight_twelve);
