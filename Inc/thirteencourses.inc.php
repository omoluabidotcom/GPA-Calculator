...
if (isset($_POST['gpcalc'])) {
    ...
    && !empty($_POST['courseunit_thirteen']) && !empty($_POST['coursescore_one']) && !empty($_POST['coursescore_two']) 
    ...
    && !empty($_POST['coursescore_nine']) && !empty($_POST['coursescore_ten']) && !empty($_POST['coursescore_eleven']) 
    && !empty($_POST['coursescore_twelve']) && !empty($_POST['coursescore_thirteen']) ) 
    {
        ...
        + $courseunit_twelve + $courseunit_thirteen;
        ...
        + $gp_ten + $gp_eleven + $gp_twelve + $gp_thirteen;
